...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
        ...
        //usamos classe anônima fica para consulta
        /*
        ...
        */
        //usando metodo comparing com interface funcional "Function"
        /*
        System.out.println("\nOrdem numero telefone: ");
        ...
        */
        ...
        System.out.println("\nOrdem nome contato: ");
        Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(new ComparatorOrdemNome1());
...
class ComparatorOrdemNome1 implements Comparator<Map.Entry<Integer, Contato>> {
